...
const TRANSLATIONS = [
    'nl' => [
        ...
        'voortgang.col.invoice_period' => 'Factuurperiode',
        'voortgang.col.total' => 'Totaal',
        'voortgang.col.progress' => '% Gecont.+Geann.',
        'voortgang.col.original_amount' => 'Contract V.Prijs',
        ...
        'voortgang.modal.proforma_title' => 'Openstaande proforma',
        'voortgang.modal.proforma_empty' => 'Geen openstaande proforma op deze werkorders.',
        'voortgang.col.proforma_no' => 'Proforma',
        'voortgang.col.proforma_amount' => 'Bedrag dit contract',
        'voortgang.col.amount' => 'Bedrag',
        'voortgang.col.proforma_no_contract' => 'Geen contract',
        'voortgang.proforma.other_tooltip' => 'Dit bedrag komt van werkorders die in deze proforma zitten, maar horen bij contract %s',
        'voortgang.proforma.unassigned_tooltip' => 'Dit bedrag komt van werkorders die in deze proforma zitten, maar niet aan een contract toegewezen zijn.',
        'voortgang.proforma.this_progress' => 'Dit contract: %s',
        'voortgang.proforma.other_progress' => 'Andere contracten: %s',
        'voortgang.modal.proforma_lines_title' => 'Werkorders op proforma',
        'voortgang.modal.loading' => 'Laden…',
    ...
    'en' => [
        ...
        'voortgang.col.original_amount' => 'Contract S.Price',
        ...
        'voortgang.modal.proforma_title' => 'Open proforma',
        'voortgang.modal.proforma_empty' => 'No open proforma on these work orders.',
        'voortgang.col.proforma_no' => 'Proforma',
        'voortgang.col.proforma_amount' => 'Amount this contract',
        'voortgang.col.amount' => 'Amount',
        'voortgang.col.proforma_no_contract' => 'No contract',
        'voortgang.proforma.other_tooltip' => 'This amount comes from work orders on this proforma that belong to contract %s',
        'voortgang.proforma.unassigned_tooltip' => 'This amount comes from work orders on this proforma that are not assigned to a contract.',
        'voortgang.proforma.this_progress' => 'This contract: %s',
        'voortgang.proforma.other_progress' => 'Other contracts: %s',
        'voortgang.modal.proforma_lines_title' => 'Work orders on proforma',
        'voortgang.modal.loading' => 'Loading…',
    ...
    'de' => [
        ...
        'voortgang.col.invoice_period' => 'Rechnungsperiode',
        'voortgang.col.total' => 'Gesamt',
        'voortgang.col.progress' => '% Gepr.+Annul.',
        'voortgang.col.original_amount' => 'Vertrag V.Preis',
        ...
        'voortgang.modal.proforma_title' => 'Offene Proforma',
        'voortgang.modal.proforma_empty' => 'Keine offene Proforma für diese Arbeitsaufträge.',
        'voortgang.col.proforma_no' => 'Proforma',
        'voortgang.col.proforma_amount' => 'Betrag dieser Vertrag',
        'voortgang.col.amount' => 'Betrag',
        'voortgang.col.proforma_no_contract' => 'Kein Vertrag',
        'voortgang.proforma.other_tooltip' => 'Dieser Betrag stammt von Arbeitsaufträgen auf dieser Proforma, die zu Vertrag %s gehören',
        'voortgang.proforma.unassigned_tooltip' => 'Dieser Betrag stammt von Arbeitsaufträgen auf dieser Proforma, die keinem Vertrag zugeordnet sind.',
        'voortgang.proforma.this_progress' => 'Dieser Vertrag: %s',
        'voortgang.proforma.other_progress' => 'Andere Verträge: %s',
        'voortgang.modal.proforma_lines_title' => 'Arbeitsaufträge auf Proforma',
        'voortgang.modal.loading' => 'Laden…',
    ...
    'fr' => [
        ...
        'voortgang.col.description' => 'Description',
        'voortgang.col.invoice_period' => 'Période de facturation',
        'voortgang.col.total' => 'Total',
        'voortgang.col.progress' => '% Contr.+Annul.',
        'voortgang.col.original_amount' => 'Prix V. Contrat',
        ...
        'voortgang.modal.proforma_title' => 'Proforma ouverte',
        'voortgang.modal.proforma_empty' => 'Aucune proforma ouverte pour ces ordres de travail.',
        'voortgang.col.proforma_no' => 'Proforma',
        'voortgang.col.proforma_amount' => 'Montant ce contrat',
        'voortgang.col.amount' => 'Montant',
        'voortgang.col.proforma_no_contract' => 'Sans contrat',
        'voortgang.proforma.other_tooltip' => 'Ce montant provient d’ordres de travail de cette proforma qui appartiennent au contrat %s',
        'voortgang.proforma.unassigned_tooltip' => 'Ce montant provient d’ordres de travail de cette proforma qui ne sont pas rattachés à un contrat.',
        'voortgang.proforma.this_progress' => 'Ce contrat : %s',
        'voortgang.proforma.other_progress' => 'Autres contrats : %s',
        'voortgang.modal.proforma_lines_title' => 'Ordres de travail sur proforma',
        'voortgang.modal.loading' => 'Chargement…',
